...
{
	$(".right-content").load("goToWorkGroup.do?method=goToWorkGroup&orgOid="+orgOid+"&unitOid="+unitOid);
}
 function workUnitLocation(unitOid)
{
	 unitOid=unitOid;
	 $(".right-content").load("goToWorkGroup.do?method=goToWorkGroup&unitOid="+unitOid);
} 
</script>
</body>
</html>