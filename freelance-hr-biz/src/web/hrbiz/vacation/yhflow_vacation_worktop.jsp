	...
	worktop = new Worktop([
		{
			xtype:'Xtable',
			xname:'grid',
			url: 'listVacationInfo.do?method=listVacationInfo',
			rowNumber: true,
			checkbox: true,
...
function goVacationFlowStart(){
	Widget.openContent("goVacationFlowStartPage.do?method=goVacationFlowStartPage");
}
</script>
</head>
...
<div>
	<div class='handle-btn-group'>
		...
		<div class="handle-btn clearfix" id="fr_tbar">
			...
			<button class="btn_add" onclick="goVacationFlowStart()">发起流程</button>
	    </div>
		<!-- 列表内容展示-->
