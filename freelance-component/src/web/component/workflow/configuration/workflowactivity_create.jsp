...
<!--
 * @function    活动信息新增页面
 * @page name   workflowactivity_create.jsp
 * @author      liul
 * @created     2017/11/28
 * @version     1.0
-->
...
<head lang="l">
    <meta charset="UTF-8">
    <title>活动信息新增页面</title>
    <script type="text/javascript" src="component/workflow/configuration/js/script.js"></script>
	<script type="text/javascript" src="js/comm/customJs.js"></script>
</head>
<body>
<div id="showmodal" class="modal-content">
<form id="workflowActivityForm" class="form-inline" action="insertWorkflowActivity.do?method=insertActivity" method="post" onsubmit="return false">
		<div class="modal-header">
            <button type="button" class="close close-popdown" data-dismiss="modal" aria-label="Close" button-click="widget-close">
            	<span aria-hidden="true" >&times;</span>
            </button>
            <h4 class="modal-title">活动信息&gt;新增</h4>
    	</div>		
